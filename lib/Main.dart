  ...
  runApp(
    MaterialApp(
      ...
      routes: {
        ...
        '/guns-bulldog': (context) =>
            GunsScreen(body: body['data'][3]), //phantom
        '/guns-phantom': (context) =>
            GunsScreen(body: body['data'][4]), //bulldog
        ...
        '/guns-classic': (context) =>
            GunsScreen(body: body['data'][8]), //classic
        '/guns-ghost': (context) => GunsScreen(body: body['data'][9]), //ghost
        '/guns-sheriff': (context) =>
            GunsScreen(body: body['data'][10]), //sheriff
        '/guns-shorty': (context) =>
            GunsScreen(body: body['data'][11]), //shorty
        '/guns-operator': (context) =>
            GunsScreen(body: body['data'][12]), //operator
        '/guns-guardian': (context) =>
            GunsScreen(body: body['data'][13]), //guardian
        '/guns-marshal': (context) =>
            GunsScreen(body: body['data'][14]), //marhsal
        '/guns-specter': (context) =>
