...
class Jett extends StatefulWidget {
  ...
  @override
  State<Jett> createState() => _characterState();
}

class _characterState extends State<Jett> {
  @override
