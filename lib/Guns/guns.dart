                    ...
                    children: [
                      Row(
                        ...
                        children: <Widget>[
                          StatsCard(
                            heading: "fire rate",
                            value: body.weaponStats!.fireRate!.toStringAsFixed(2),
                            units: "rds/sec",
                          ...
                          StatsCard(
                            heading: "run speed",
                            value: (6.75 *
                                        body.weaponStats!.runSpeedMultiplier!).toStringAsFixed(2),
                            units: "m/sec",
                      ...
                      Row(
                        ...
                        children: [
                          StatsCard(
                            heading: "equip speed",
                            value:
                                body.weaponStats!.equipTimeSeconds.toString(),
                            units: "sec",
                          ...
                          StatsCard(
                            ...
                            value: body.weaponStats!.adsStats != null
                                ? "${body.weaponStats!.firstBulletAccuracy!} / ${
                                  (body.weaponStats!.adsStats!.firstBulletAccuracy) < 0 
                                    ? 0 
                                    : body.weaponStats!.adsStats!.firstBulletAccuracy.toStringAsFixed(2)}"
                                : "${body.weaponStats!.firstBulletAccuracy!}",
                            units: "deg (hip/ads)",
                      ...
                      Row(
                        ...
                        children: [
                          StatsCard(
                            ...
                            value:
                                body.weaponStats!.reloadTimeSeconds.toString(),
                            units: "sec",
                            margin: EdgeInsets.fromLTRB(0, 4, 4, 8),
                          ),
                          StatsCard(
                            heading: "magazine",
                            value: body.weaponStats!.magazineSize.toString(),
                            units: "rds",
